  ...
  return (
    <div className="relative">
        ...
        <div className="grid gap-14 md:grid-cols-[1.1fr_0.9fr] md:items-center">
          <div className="space-y-7">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <Link
                href="/process"
                className="group inline-flex items-center gap-2 rounded-full bg-[var(--accent)] px-7 py-3.5 font-medium text-[var(--bg-base)] transition-all hover:bg-[var(--accent-strong)] hover:shadow-[0_0_30px_var(--accent-soft)]"
              >
                Process audio
              ...
              <Link
                href="#how"
                className="inline-flex items-center gap-2 rounded-full border border-[var(--line-strong)] bg-[var(--bg-surface)]/40 px-6 py-3 text-[var(--text-secondary)] transition-all hover:border-[var(--accent)]/40 hover:text-[var(--accent)]"
              >
                How it works
              </Link>
            </div>
            ...
            <dl className="grid grid-cols-3 gap-6 pt-8">
              ...
              <Stat label="upload cap" value="60 MB" />
            </dl>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-24">
        <div className="glass overflow-hidden rounded-[var(--radius-xl)] p-10 md:p-14">
          <div className="flex flex-col items-start gap-8 md:flex-row md:items-center md:justify-between">
            <div className="max-w-xl space-y-3">
              <h3 className="text-3xl font-medium">Drop a track. Get a clean version back.</h3>
            ...
            <Link
              href="/process"
              className="inline-flex items-center gap-2 rounded-full bg-[var(--accent)] px-8 py-4 font-medium text-[var(--bg-base)] transition-all hover:bg-[var(--accent-strong)] hover:shadow-[0_0_30px_var(--accent-soft)]"
            >
              Launch processor
...
function Stat({ label, value }: { label: string; value: string }) {
  return (
    <div>
      ...
      <dd className="mt-2 text-3xl font-medium tracking-tight text-[var(--text-primary)]">
        {value}
      </dd>
    </div>
  );
...
function Card({
  ...
  return (
    <article className="group relative overflow-hidden rounded-[var(--radius-lg)] border border-[var(--line)] bg-[var(--bg-elevated)]/60 p-6 transition-all hover:border-[var(--accent)]/40 hover:bg-[var(--bg-surface)]/80">
      <div className="flex items-start justify-between gap-4">
        ...
        <span className="shrink-0 rounded-full border border-[var(--line-strong)] bg-[var(--bg-base)] px-2.5 py-0.5 font-mono text-[9px] uppercase tracking-[0.2em] text-[var(--text-muted)]">
          {tag}
        </span>
      </div>
...
function ScienceRow({
  ...
  return (
    <div className="grid gap-4 bg-[var(--bg-elevated)] p-6 md:grid-cols-[140px_1fr_1fr] md:items-start md:gap-6">
      <div>
...
function HeroVisual() {
  return (
    <div className="relative aspect-square w-full overflow-hidden rounded-[var(--radius-xl)] border border-[var(--line)] bg-[var(--bg-elevated)] drift">
        ...
        <div className="grid h-full w-full place-items-center">
          <div className="relative grid h-full w-full place-items-center">
            <div className="pointer-events-none absolute inset-0 grid place-items-center">
              <div className="h-56 w-56 rounded-full border border-[var(--accent)]/30 pulse-ring" />
            </div>
            <div className="pointer-events-none absolute inset-0 grid place-items-center">
              <div className="h-72 w-72 rounded-full border border-[var(--signal)]/20" />
            </div>
            <div className="relative flex h-44 w-full max-w-[70%] items-end justify-center gap-[3px]">
      ...
      <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between font-mono text-[10px] uppercase tracking-[0.3em] text-[var(--text-muted)]">
        <span>fft 2048</span>
        <span>hop 512</span>
        <span>sr 44.1k</span>
      </div>
